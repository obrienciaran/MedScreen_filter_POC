...
trustworthy number) is reported separately from stance recall (conditional on
retrieval). Recall@k shows rank sensitivity; false-contradiction rate guards against
a harness that flags everything; the failure taxonomy says *where* recall dies.
"""
